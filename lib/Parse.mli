...
(**
    Functions for parsing scala programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a scala program from a string into a typed OCaml CST.
...
(** Parse a scala program from a file into a typed OCaml CST.
